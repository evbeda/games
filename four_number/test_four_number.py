...
class TestFourNumber(unittest.TestCase):
    ...
    def test_play_smaller_number(self):
        self.assertEqual(self.game.same_enter_number(19), 'invalid number')
        self.assertTrue(self.game.is_playing)

    def test_play_invalid_number(self):
        self.assertEqual(self.game.same_enter_number(1210), 'invalid number')
        self.assertEqual(self.game.same_enter_number(2210), 'invalid number')
        self.assertEqual(self.game.same_enter_number(1291), 'invalid number')
        self.assertEqual(self.game.same_enter_number(8121), 'invalid number')

    def test_play_valid_number(self):
        self.assertEqual(self.game.same_enter_number(1230), 'valid number')
        self.assertEqual(self.game.same_enter_number(3210), 'valid number')
        self.assertEqual(self.game.same_enter_number(1298), 'valid number')
        self.assertEqual(self.game.same_enter_number(8145), 'valid number')

    def test_play_bigger_number(self):
        self.assertEqual(self.game.same_enter_number(40000), 'invalid number')
        self.assertTrue(self.game.is_playing)

    def test_play_incorrect_number(self):
        self.assertEqual(self.game.play(2222), 'invalid number')

    def test_play_correct_number_equal(self):
        self.assertEqual(self.game.play(1234), '4G, You win')
        self.assertFalse(self.game.is_playing)

    def test_play_correct_number_1(self):
        self.assertEqual(self.game.play(1240), '2G 1R')
        self.assertTrue(self.game.is_playing)

    def test_play_incorrect_number_2(self):
        self.assertEqual(self.game.same_enter_number(2554), 'invalid number')
        self.assertTrue(self.game.is_playing)

    def test_play_correct_number_3(self):
        self.assertEqual(self.game.play(3421), '4R')
        self.assertTrue(self.game.is_playing)
